...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(false)
    if (error) toast.error(error.message.includes('invalid-credential') ? 'Incorrect email or password' : error.message)
  ...
  async function handleGoogle() {
    ...
    else { toast.success('Signed in with Google! 🎉'); navigate(from, { replace: true }) }
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 pt-8 pb-10 text-center relative">
            ...
            <p className="text-blue-100 text-sm mt-1">Sign in to MediCare Plus</p>
            {/* Wave */}
          ...
          <div className="px-8 py-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" value={form.email}
                    ...
                    className={`w-full pl-10 pr-3 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.email ? 'border-red-400 bg-red-50' : 'border-gray-200'}`}/>
                </div>
              ...
              <button type="submit" disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:opacity-60 text-white py-3 rounded-xl font-semibold text-sm transition-all shadow-lg shadow-blue-200 flex items-center justify-center gap-2">
